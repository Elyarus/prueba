...
public class Controlador extends HttpServlet { // Declaración de la clase Controlador que extiende HttpServlet
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            // Consulta SQL para seleccionar todas las películas de la tabla 'animes'
            ...
            String json = mapper.writeValueAsString(animes);  // Convertir la lista de películas a formato JSON
